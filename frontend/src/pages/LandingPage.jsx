        ...
        <div className="bg-white min-h-screen font-sans text-slate-900 overflow-x-hidden">
            ...
            <section className="relative pt-20 pb-20 lg:pt-32 lg:pb-32 px-6">
                <div className="max-w-7xl mx-auto text-center relative z-10">
                    <div className="inline-block mb-6 px-4 py-1.5 rounded-full bg-sky-50 text-sky-600 font-semibold text-sm border border-sky-100 animate-fade-in-up">
                    ...
                    <p className="text-xl text-slate-500 max-w-2xl mx-auto mb-12 leading-relaxed animate-fade-in-up delay-200">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up delay-300">
                        <button
                            ...
                            className="px-8 py-4 bg-slate-900 text-white rounded-full font-bold text-lg hover:bg-slate-800 transition-all hover:scale-105 shadow-xl shadow-slate-200"
                        >
                            Start Writing Free
                        </button>
                        <button
            ...
            <section className="py-24 bg-slate-50 px-6">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4">Everything you need to write a bestseller.</h2>
                        <p className="text-slate-500">Powerful tools wrapped in a beautiful, distraction-free interface.</p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {/* Card 1 */}
                        <div className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-xl transition-shadow border border-slate-100 md:col-span-2 relative overflow-hidden group">
                        ...
                        <div className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-xl transition-shadow border border-slate-100 group">
                            ...
                            <h3 className="text-2xl font-bold mb-3">Zen Editor</h3>
                        ...
                        {/* Card 4 */}
                        <div className="bg-slate-900 p-8 rounded-3xl shadow-lg md:col-span-2 text-white relative overflow-hidden group">
                            <div className="relative z-10">
            ...
            <section className="py-32 px-6 bg-white overflow-hidden relative">
                <div className="max-w-4xl mx-auto text-center relative z-10">
                    <h2 className="text-5xl font-bold mb-8 tracking-tight">Ready to tell your story?</h2>
                    <button
                        onClick={() => navigate('/signup')}
                        className="px-10 py-5 bg-sky-500 text-white rounded-full font-bold text-xl hover:bg-sky-400 transition-all hover:scale-105 shadow-2xl shadow-sky-200"
                    >
                        Get Started for Free
                    </button>
                    <p className="mt-6 text-slate-400 text-sm">No credit card required • Unlimited drafts</p>
                </div>
                <div className="absolute bottom-0 left-0 w-full h-1/2 bg-gradient-to-t from-slate-50 to-transparent -z-10"></div>
            </section>
            ...
            <footer className="bg-slate-50 py-12 px-6 border-t border-slate-100">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center text-slate-500 text-sm">
                    <div className="flex items-center gap-2 mb-4 md:mb-0">
                        ...
                        <span className="font-bold text-slate-700">StoryWeaver AI</span>
                    </div>
