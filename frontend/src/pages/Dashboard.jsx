        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-24">
                <div className="feature-card group cursor-pointer" onClick={() => setShowCreateModal(true)}>
                    <div className="w-16 h-16 bg-sky-100 rounded-full flex items-center justify-center text-sky-600 mb-6 group-hover:scale-110 transition-transform">
            ...
            <div className="mb-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {stories.map(story => (
                        ...
                        >
                            <div className="h-40 bg-slate-50 rounded-lg mb-4 flex items-center justify-center text-slate-300 group-hover:bg-sky-50 group-hover:text-sky-500 transition-colors">
